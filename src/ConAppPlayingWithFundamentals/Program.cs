...
class Program
{
	...
	private static void DisplayMenu()
	{
		...
		WriteLine("31. GetDataFromDb");
		WriteLine("32. GetPeopleFromWeb");
		WriteLine("33. ReverseArrayCheck");
		WriteLine("34. GtMoreUsers");
		WriteLine("35. GetMatchingPairs03");
		WriteLine("36. GetMatchingPairs04");
