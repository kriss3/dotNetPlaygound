...
- Added CPM (now completed) 
- Moved all projects to src for more clarity and cleanness of the solution. (now completed) 
...
- Find All EF projects and combine in one or delete old one  
